...
This file outlines how to propose a change to gigs. It is based on the
tidyverse contributing guidelines.

## Planned development

This package is currently in a stable state of development, with some
degree of active subsequent development as envisioned by the primary
authors. We plan to add:

- Additional growth standards if requested by package users and deemed
  within the package scope

### Scope

This package’s scope is limited to international growth standards. As a
consequence, feature requests or pull requests which add support for
growth references (e.g. the CDC growth charts or UK-WHO growth charts)
will be rejected. If you want to use growth references in your work, you
may find other packages more useful. The `childsds` package can work
with many references if you wish to use these instead.
...
issue and see if a maintainer agrees that it is necessary. If you’ve
...
help you write a unit test, if needed). You can check out the tidyverse
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("ropensci/gigs", fork = TRUE)`.
...
- For user-facing changes, add a bullet to the top of `NEWS.md`
  (i.e. just below the first header). Follow the style described in the
  tidyverse [style guide](https://style.tidyverse.org/news.html).
...
- New code should follow the tidyverse [style
  ...
  these styles, but please don’t restyle existing code which is not
  altered as part of your PR.
