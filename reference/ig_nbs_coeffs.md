...
gestational ages for either sex, for the INTERGROWTH-21^(st)
weight/length/head circumference-for-gestational age standards. The
lists are ordered by acronym, then sex.
